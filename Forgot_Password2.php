...
<body>
            ...
            <div class="col-right">
                <div class="login-form">
                    ...
                    <form action="" method="POST">
                        ...
                        <p id="sq">
                            Secret Question: <span id="sq"></span>
                        </p>
                        <p id="p-sq">
    ...
    <script>
        var eml=<?php echo $username; ?>;
        document.getElementById("head-email").value=eml;
        ...
        var ress=<?php echo $res; ?>;
        if(ress==true)
        {
            document.getElementById("p-otp").style.display="block";
        }
    </script>
</body>
</html>
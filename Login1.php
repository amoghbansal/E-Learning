...
<head>
    ...
    if (isset($_REQUEST['submit']))
    {
        ...
        $res=mysqli_query($con,"select count(*) as cnt from login where email='$user' and password='$pass';");
        $row = mysqli_fetch_array($res, MYSQLI_ASSOC); // Use something like this to get the result
        $quantity = $row['cnt'];
        echo $quantity;
    }
    ?>
                ...
                <div class="login-form">
                    ...
                    <form action="" method="POST">
                        ...
                        <p>
                            ...
                            <input required minlength="8" required type="password" id="password" name="password" placeholder="Password" aria-describedby="password-validation">
                        </p>
                        <p>
